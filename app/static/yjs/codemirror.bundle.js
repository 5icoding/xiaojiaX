...
/* harmony export */ });
/* harmony import */ var lib0_mutex_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lib0/mutex.js */ "./node_modules/lib0/mutex.js");
...
/* harmony import */ var lib0_function_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lib0/function.js */ "./node_modules/lib0/function.js");
/* harmony import */ var lib0_eventloop_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lib0/eventloop.js */ "./node_modules/lib0/eventloop.js");
/* harmony import */ var lib0_diff_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lib0/diff.js */ "./node_modules/lib0/diff.js");
    ...
    const performChange = () => {
      ...
      for (let i = 0; i < event.delta.length; i++) {
        ...
        if (d.retain) {
          ...
          if (index < anchor) {
            anchor = lib0_math_js__WEBPACK_IMPORTED_MODULE_1__.max(anchor - d.delete, index)
          }
          if (index < head) {
            head = lib0_math_js__WEBPACK_IMPORTED_MODULE_1__.max(head - d.delete, index)
          }
  ...
  binding._mux(() => {
    binding.doc.transact(() => {
      if (changes.length > 1) {
        ...
        const d = lib0_diff_js__WEBPACK_IMPORTED_MODULE_2__.simpleDiffString(binding.type.toString(), binding.cmDoc.getValue())
        ...
        const delLen = change.removed.map(s => s.length).reduce(lib0_math_js__WEBPACK_IMPORTED_MODULE_1__.add) + change.removed.length - 1
        if (delLen > 0) {
...
const updateRemoteSelection = (y, cm, type, cursors, clientId, awareness) => {
  ...
  if (anchor !== null && head !== null && anchor.type === type && head.type === type) {
    ...
    if (m && lib0_function_js__WEBPACK_IMPORTED_MODULE_4__.equalityFlat(aw.cursor.anchor, m.awCursor.anchor) && lib0_function_js__WEBPACK_IMPORTED_MODULE_4__.equalityFlat(aw.cursor.head, m.awCursor.head)) {
    ...
    if (head.index !== anchor.index) {
      if (from.line !== to.line && from.ch !== 0) {
        ...
        sel.push(cm.markText(from, new (codemirror__WEBPACK_IMPORTED_MODULE_0___default().Pos)(from.line + 1, 0), { css: `background-color: ${user.color}70;`, inclusiveRight: false, inclusiveLeft: false }))
        from = new (codemirror__WEBPACK_IMPORTED_MODULE_0___default().Pos)(from.line + 1, 0)
      }
      while (from.line !== to.line) {
        ...
        sel.push(cm.setBookmark(new (codemirror__WEBPACK_IMPORTED_MODULE_0___default().Pos)(from.line, 0), { widget: createEmptyLinePlaceholder(user.color) }))
        from = new (codemirror__WEBPACK_IMPORTED_MODULE_0___default().Pos)(from.line + 1, 0)
      }
...
class CodemirrorBinding {
  ...
  constructor (textType, codeMirror, awareness = null, { yUndoManager = null } = {}) {
    ...
    this._mux = (0,lib0_mutex_js__WEBPACK_IMPORTED_MODULE_5__.createMutex)()
    // set initial value
    ...
    this._debounceCursorEvent = lib0_eventloop_js__WEBPACK_IMPORTED_MODULE_6__.createDebouncer(10)
...
const setupWS = (provider) => {
  if (provider.shouldConnect && provider.ws === null) {
    ...
    websocket.onclose = (event) => {
      ...
      setTimeout(
        setupWS,
        lib0_math__WEBPACK_IMPORTED_MODULE_6__.min(
          lib0_math__WEBPACK_IMPORTED_MODULE_6__.pow(2, provider.wsUnsuccessfulReconnects) * 100,
    ...
    this._checkInterval = /** @type {any} */ (setInterval(() => {
      if (
        ...
        messageReconnectTimeout <
          lib0_time__WEBPACK_IMPORTED_MODULE_5__.getUnixTime() - this.wsLastMessageReceived
      ) {
...
/* harmony import */ var y_websocket__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! y-websocket */ "./node_modules/y-websocket/src/y-websocket.js");
/* harmony import */ var y_codemirror__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! y-codemirror */ "./node_modules/y-codemirror/src/y-codemirror.js");
/* harmony import */ var codemirror_mode_javascript_javascript_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! codemirror/mode/javascript/javascript.js */ "./node_modules/codemirror/mode/javascript/javascript.js");
/* harmony import */ var codemirror_mode_javascript_javascript_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_javascript_javascript_js__WEBPACK_IMPORTED_MODULE_1__);
/* eslint-env browser */
...
window.addEventListener('load', () => {
  const ydoc = new yjs__WEBPACK_IMPORTED_MODULE_2__.Doc()
  const provider = new y_websocket__WEBPACK_IMPORTED_MODULE_3__.WebsocketProvider(
    'wss://localhost:3000', // use the public ws server
  ...
  const editor = codemirror__WEBPACK_IMPORTED_MODULE_0___default()(editorContainer, {
    mode: 'javascript',
    lineNumbers: true
  })
  ...
  const binding = new y_codemirror__WEBPACK_IMPORTED_MODULE_4__.CodemirrorBinding(ytext, editor, provider.awareness)
  ...
  // @ts-ignore
  window.example = { provider, ydoc, ytext, binding, Y: yjs__WEBPACK_IMPORTED_MODULE_2__ }
})
